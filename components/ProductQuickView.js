...
export default function ProductQuickView({ product }) {
    ...
    console.log('inside QV: product =', product);
        ...
        <Dialog as="div" className="relative z-10" onClose={() => setOpen(false)}>
          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-stretch md:items-center justify-center min-h-full text-center md:px-2 lg:px-4">
              ...
              >
                <Dialog.Panel className="flex text-base text-left transform transition w-full md:max-w-2xl md:px-4 md:my-8 lg:max-w-7xl">
                  <div className={`w-full relative flex items-center bg-[${product.bgColor}] px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8`}>
                    <button
                      type="button"
