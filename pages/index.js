...
export default function App() {
  ...
  const showProductQuickView = ({ product }) => {
    console.log('showing product quickview...', product);
    setQuickView(<ProductQuickView product={product} />)
  }
    ...
    <div className="bg-white">
      ...
      <div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {quickView && <ProductQuickView product={products[0]} />}
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              {/* Product grid */}
              <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 md:grid-cols-6 lg:col-span-3 lg:gap-x-2">
